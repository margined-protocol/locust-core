...
type HostZone struct {
	...
	RemainingDelegatedBalance cosmossdk_io_math.Int `protobuf:"bytes,18,opt,name=remaining_delegated_balance,json=remainingDelegatedBalance,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"remaining_delegated_balance"`
