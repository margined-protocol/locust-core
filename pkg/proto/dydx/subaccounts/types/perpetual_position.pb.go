...
import (
	fmt "fmt"
	github_com_dydxprotocol_v4_chain_protocol_dtypes "github.com/margined-protocol/locust-core/pkg/math/dtypes"
...
type PerpetualPosition struct {
	...
	Quantums github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=quantums,proto3,customtype=cosmossdk.io/math.Int" json:"quantums"`
	// The funding_index of the `Perpetual` the last time this position was
	// settled.
	FundingIndex github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=funding_index,json=fundingIndex,proto3,customtype=cosmossdk.io/math.Int" json:"funding_index"`
	// The quote_balance of the `Perpetual`.
	QuoteBalance github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=quote_balance,json=quoteBalance,proto3,customtype=cosmossdk.io/math.Int" json:"quote_balance"`
}
...
var fileDescriptor_e659838f8a8f5498 = []byte{
	...
	0xa4, 0x45, 0x4a, 0x24, 0x3d, 0x3f, 0x3d, 0x1f, 0x2c, 0xa3, 0x0f, 0x62, 0x41, 0xd4, 0x2b, 0xad,
	0x61, 0xe2, 0x12, 0x0c, 0x80, 0x19, 0x16, 0x00, 0x35, 0x4b, 0x48, 0x91, 0x8b, 0x07, 0x61, 0x43,
	0x66, 0x8a, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x6f, 0x10, 0x37, 0x5c, 0xcc, 0x33, 0x45, 0xc8, 0x8b,
	...
	,
}
