...
type HostZone struct {
	...
	LastRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,12,opt,name=last_redemption_rate,json=lastRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"last_redemption_rate"`
	// Current redemption rate
	RedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,13,opt,name=redemption_rate,json=redemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"redemption_rate"`
	// Min outer redemption rate - adjusted by governance
	MinRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,14,opt,name=min_redemption_rate,json=minRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_redemption_rate"`
	// Max outer redemption rate - adjusted by governance
	MaxRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,15,opt,name=max_redemption_rate,json=maxRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_redemption_rate"`
	// Min inner redemption rate - adjusted by controller
	MinInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,16,opt,name=min_inner_redemption_rate,json=minInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_inner_redemption_rate"`
	// Max inner redemption rate - adjusted by controller
	MaxInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,17,opt,name=max_inner_redemption_rate,json=maxInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_inner_redemption_rate"`
	// Total delegated balance on the host zone delegation account
	DelegatedBalance cosmossdk_io_math.Int `protobuf:"bytes,18,opt,name=delegated_balance,json=delegatedBalance,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"delegated_balance"`
...
type DelegationRecord struct {
	...
	NativeAmount cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=native_amount,json=nativeAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"native_amount"`
...
type UnbondingRecord struct {
	...
	StTokenAmount cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=st_token_amount,json=stTokenAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"st_token_amount"`
	// The corresponding amount of native tokens that should be unbonded
	NativeAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=native_amount,json=nativeAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"native_amount"`
...
type SlashRecord struct {
	...
	NativeAmount cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=native_amount,json=nativeAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"native_amount"`
