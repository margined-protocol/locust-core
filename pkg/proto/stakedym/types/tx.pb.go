...
type MsgRedeemStake struct {
	...
	StTokenAmount cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=st_token_amount,json=stTokenAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"st_token_amount"`
}
...
type MsgAdjustDelegatedBalance struct {
	Operator         string                                 `protobuf:"bytes,1,opt,name=operator,proto3" json:"operator,omitempty"`
	DelegationOffset cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=delegation_offset,json=delegationOffset,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"delegation_offset"`
...
type MsgUpdateInnerRedemptionRateBounds struct {
	...
	MinInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=min_inner_redemption_rate,json=minInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_inner_redemption_rate"`
	MaxInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=max_inner_redemption_rate,json=maxInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_inner_redemption_rate"`
}
