...
type QueryMarketSummaryResponse struct {
	...
	Supply_APY cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=supply_APY,json=supplyAPY,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"supply_apy"`
	// Borrow APY is the current interest rate borrowers are being charged on their loans. For example, 0.2 would mean 20% APY.
	Borrow_APY cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=borrow_APY,json=borrowAPY,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"borrow_apy"`
	...
	Supplied cosmossdk_io_math.Int `protobuf:"bytes,7,opt,name=supplied,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"supplied"`
	...
	Reserved cosmossdk_io_math.Int `protobuf:"bytes,8,opt,name=reserved,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"reserved"`
	...
	Collateral cosmossdk_io_math.Int `protobuf:"bytes,9,opt,name=collateral,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"collateral"`
	...
	Borrowed cosmossdk_io_math.Int `protobuf:"bytes,10,opt,name=borrowed,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"borrowed"`
	...
	Liquidity cosmossdk_io_math.Int `protobuf:"bytes,11,opt,name=liquidity,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"liquidity"`
	...
	MaximumBorrow cosmossdk_io_math.Int `protobuf:"bytes,12,opt,name=maximum_borrow,json=maximumBorrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"maximum_borrow"`
	...
	MaximumCollateral cosmossdk_io_math.Int `protobuf:"bytes,13,opt,name=maximum_collateral,json=maximumCollateral,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"maximum_collateral"`
	...
	MinimumLiquidity cosmossdk_io_math.Int `protobuf:"bytes,14,opt,name=minimum_liquidity,json=minimumLiquidity,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"minimum_liquidity"`
	// uToken Supply is the total amount of a base token's associated uToken in circulation.
	UTokenSupply cosmossdk_io_math.Int `protobuf:"bytes,15,opt,name=uToken_supply,json=uTokenSupply,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"utoken_supply"`
	...
	AvailableBorrow cosmossdk_io_math.Int `protobuf:"bytes,16,opt,name=available_borrow,json=availableBorrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"available_borrow"`
	...
	AvailableWithdraw cosmossdk_io_math.Int `protobuf:"bytes,17,opt,name=available_withdraw,json=availableWithdraw,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"available_withdraw"`
	...
	AvailableCollateralize cosmossdk_io_math.Int `protobuf:"bytes,18,opt,name=available_collateralize,json=availableCollateralize,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"available_collateralize"`
	...
	OracleHistoricPrice *cosmossdk_io_math.LegacyDec `protobuf:"bytes,19,opt,name=oracle_historic_price,json=oracleHistoricPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"oracle_historic_price,omitempty"`
...
type QueryAccountSummaryResponse struct {
	...
	SuppliedValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=supplied_value,json=suppliedValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"supplied_value"`
	...
	// value than if prices were all available.
	CollateralValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=collateral_value,json=collateralValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"collateral_value"`
	...
	// value than if prices were all available.
	BorrowedValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=borrowed_value,json=borrowedValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"borrowed_value"`
	...
	// missing.
	BorrowLimit *cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=borrow_limit,json=borrowLimit,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"borrow_limit,omitempty"`
	...
	// limit than if prices were all available. Will be null if an oracle price required for computation is
	// missing.
	LiquidationThreshold *cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=liquidation_threshold,json=liquidationThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"liquidation_threshold,omitempty"`
	// Spot Supplied Value is supplied value but always uses the most recent available spot prices.
	SpotSuppliedValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=spot_supplied_value,json=spotSuppliedValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"spot_supplied_value"`
	// Spot Collateral Value is collateral value but always uses the most recent available spot prices.
	SpotCollateralValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=spot_collateral_value,json=spotCollateralValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"spot_collateral_value"`
	// Spot Borrowed Value is borrowed value but always uses the most recent available spot prices.
	SpotBorrowedValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,8,opt,name=spot_borrowed_value,json=spotBorrowedValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"spot_borrowed_value"`
}
