...
type Params struct {
	...
	// Valid values: 0-1.
	CompleteLiquidationThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=complete_liquidation_threshold,json=completeLiquidationThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"complete_liquidation_threshold" yaml:"complete_liquidation_threshold"`
	...
	//
	// Valid values: 0-1.
	MinimumCloseFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=minimum_close_factor,json=minimumCloseFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"minimum_close_factor" yaml:"minimum_close_factor"`
	...
	// Valid values: 0-1.
	OracleRewardFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=oracle_reward_factor,json=oracleRewardFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"oracle_reward_factor" yaml:"oracle_reward_factor"`
	...
	SmallLiquidationSize cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=small_liquidation_size,json=smallLiquidationSize,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"small_liquidation_size" yaml:"small_liquidation_size"`
	...
	// Valid values: 0-1.
	DirectLiquidationFee cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=direct_liquidation_fee,json=directLiquidationFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"direct_liquidation_fee" yaml:"direct_liquidation_fee"`
	...
	// Valid values: 0-1.
	RewardsAuctionFee cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=rewards_auction_fee,json=rewardsAuctionFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"rewards_auction_fee" yaml:"oracle_reward_factor"`
}
...
type Token struct {
	...
	// Valid values: 0-1.
	ReserveFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=reserve_factor,json=reserveFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"reserve_factor" yaml:"reserve_factor"`
	...
	// Valid values: 0-1.
	CollateralWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=collateral_weight,json=collateralWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"collateral_weight" yaml:"collateral_weight"`
	...
	LiquidationThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=liquidation_threshold,json=liquidationThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"liquidation_threshold" yaml:"liquidation_threshold"`
	// Base Borrow Rate defines the minimum interest rate for borrowing this
	// asset.
	// Valid values: 0-∞
	BaseBorrowRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=base_borrow_rate,json=baseBorrowRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"base_borrow_rate" yaml:"base_borrow_rate"`
	// Kink Borrow Rate defines the interest rate for borrowing this
	// asset when supply utilization is equal to 'kink_utilization'.
	// Valid values: 0-∞
	KinkBorrowRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=kink_borrow_rate,json=kinkBorrowRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"kink_borrow_rate" yaml:"kink_borrow_rate"`
	// Max Borrow Rate defines the interest rate for borrowing this
	// asset when supply utilization is at its maximum.
	// Valid values: 0-∞
	MaxBorrowRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=max_borrow_rate,json=maxBorrowRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_borrow_rate" yaml:"max_borrow_rate"`
	// Kink Utilization defines the supply utilization value where
	// the kink in the borrow interest rate function occurs.
	// Valid values: 0-1.
	KinkUtilization cosmossdk_io_math.LegacyDec `protobuf:"bytes,8,opt,name=kink_utilization,json=kinkUtilization,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"kink_utilization" yaml:"kink_utilization"`
	...
	// Valid values: 0-1.
	LiquidationIncentive cosmossdk_io_math.LegacyDec `protobuf:"bytes,9,opt,name=liquidation_incentive,json=liquidationIncentive,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"liquidation_incentive" yaml:"liquidation_incentive"`
	...
	// Valid values: 0-1.
	MaxCollateralShare cosmossdk_io_math.LegacyDec `protobuf:"bytes,15,opt,name=max_collateral_share,json=maxCollateralShare,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_collateral_share" yaml:"max_collateral_share"`
	...
	//
	// Valid values: 0-1.
	MaxSupplyUtilization cosmossdk_io_math.LegacyDec `protobuf:"bytes,16,opt,name=max_supply_utilization,json=maxSupplyUtilization,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_supply_utilization" yaml:"max_supply_utilization"`
	...
	// withdraw uToken.
	// Valid values: 0 - inf
	MinCollateralLiquidity cosmossdk_io_math.LegacyDec `protobuf:"bytes,17,opt,name=min_collateral_liquidity,json=minCollateralLiquidity,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_collateral_liquidity" yaml:"min_collateral_liquidity"`
...
type SpecialAssetPair struct {
	...
	CollateralWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=collateral_weight,json=collateralWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"collateral_weight"`
	...
	LiquidationThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=liquidation_threshold,json=liquidationThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"liquidation_threshold"`
}
...
type SpecialAssetSet struct {
	...
	// Valid values: 0-1.
	CollateralWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=collateral_weight,json=collateralWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"collateral_weight"`
	// Liquidation threshold defines what portion of the total value of the assets
	// can contribute to a users liquidation threshold, when borrowing within the set.
	// Valid values in range [collateral_weight,1]
	LiquidationThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=liquidation_threshold,json=liquidationThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"liquidation_threshold"`
}
