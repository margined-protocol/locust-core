...
type MsgLeveragedLiquidate struct {
	...
	MaxRepay cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=max_repay,json=maxRepay,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_repay"`
}
