...
type MsgUpdateInnerRedemptionRateBounds struct {
	...
	MinInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=min_inner_redemption_rate,json=minInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_inner_redemption_rate"`
	MaxInnerRedemptionRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=max_inner_redemption_rate,json=maxInnerRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_inner_redemption_rate"`
}
...
type MsgClearBalance struct {
	Creator string                                 `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	ChainId string                                 `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	Amount  cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
...
type MsgRegisterHostZone struct {
	...
	MinRedemptionRate            cosmossdk_io_math.LegacyDec `protobuf:"bytes,13,opt,name=min_redemption_rate,json=minRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_redemption_rate"`
	MaxRedemptionRate            cosmossdk_io_math.LegacyDec `protobuf:"bytes,14,opt,name=max_redemption_rate,json=maxRedemptionRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_redemption_rate"`
...
type MsgCreateTradeRoute struct {
	...
	MinSwapAmount cosmossdk_io_math.Int `protobuf:"bytes,15,opt,name=min_swap_amount,json=minSwapAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_swap_amount"`
	// Deprecated, the trades are now executed off-chain via authz
	//
	// maximum amount of reward tokens in a single swap
	// if not provided, defaults to 10e24
	MaxSwapAmount cosmossdk_io_math.Int `protobuf:"bytes,16,opt,name=max_swap_amount,json=maxSwapAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_swap_amount"`
	// Minimum amount of reward token that must be accumulated before
	// the tokens are transferred to the trade ICA
	MinTransferAmount cosmossdk_io_math.Int `protobuf:"bytes,17,opt,name=min_transfer_amount,json=minTransferAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_transfer_amount"`
}
...
type MsgUpdateTradeRoute struct {
	...
	// minimum amount of reward tokens to initate a swap
	// if not provided, defaults to 0
	MinSwapAmount cosmossdk_io_math.Int `protobuf:"bytes,6,opt,name=min_swap_amount,json=minSwapAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_swap_amount"` // Deprecated: Do not use.
	// Deprecated, the trades are now executed off-chain via authz
	//
	// maximum amount of reward tokens in a single swap
	// if not provided, defaults to 10e24
	MaxSwapAmount cosmossdk_io_math.Int `protobuf:"bytes,7,opt,name=max_swap_amount,json=maxSwapAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_swap_amount"` // Deprecated: Do not use.
	// Minimum amount of reward token that must be accumulated before
	// the tokens are transferred to the trade ICA
	MinTransferAmount cosmossdk_io_math.Int `protobuf:"bytes,17,opt,name=min_transfer_amount,json=minTransferAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_transfer_amount"`
}
...
type MsgSetCommunityPoolRebate struct {
	...
	RebateRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=rebate_rate,json=rebateRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"rebate_rate"`
	// Number of stTokens recieved by the community pool after liquid staking
	LiquidStakedStTokenAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=liquid_staked_st_token_amount,json=liquidStakedStTokenAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"liquid_staked_st_token_amount"`
}
